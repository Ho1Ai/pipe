...
def installPackage(pkg_name: str):
    ...
    if 'lib' in config_list:
        ...
        print('Created directory for next library:', pkg_name+';')
    if('app' in config_list):
        ...
        print('Created directory for next application:',pkg_name+';')
        ...
        print('Removed tree, which contained application "' + pkg_name + '"')
